...
public class Resources {
  ...
  // 获取泛型类型
  public static <T> Class<T> getGenericType(Class clazz, int typeIdx) {
    return (Class<T>) ((ParameterizedType) clazz.getGenericSuperclass()).getActualTypeArguments()[typeIdx];
  }
